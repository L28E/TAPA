...
Simulation = 'LinearJunction';
%Simulation = 'GaussianTwoCarRC';
%Simulation = 'LinearGradient';
%Simulation = 'ExponentialGradient';

if strcmp(Simulation,'LinearGradient')
    eval('LinearGradient');
elseif strcmp(Simulation,'ExponentialGradient')
    eval('ExponentialGradient');
elseif strcmp(Simulation,'LinearJunction')
    eval('LinearJunction');
